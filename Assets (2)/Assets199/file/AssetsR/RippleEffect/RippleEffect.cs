...
public class RippleEffect : MonoBehaviour
{
    ...
    class Droplet
    {
        ...
        public void Reset()
        {
            ...
            {
                position = new Vector3(Input.mousePosition.x, Input.mousePosition.y, Input.mousePosition.z);
                Debug.Log("as" + position.x + " " + position.y + " " + position.z);
            }

            /*else
            {
                position = new Vector2(Random.value, Random.value);
                Debug.Log("11"+position.x + " " + position.y);
            }*/
            time = 0;
        }
        ...
        public Vector4 MakeShaderParameter(float aspect)
        {
            ...
            //return new Vector4(Input.mousePosition.x * aspect, Input.mousePosition.y, time, 0);
        }
    }
